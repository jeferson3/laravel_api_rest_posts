...
Route::group(['prefix' => '/', 'middleware' => 'jwt'], function (){
    ...
    Route::post('/posts/{post}/comments', [\App\Http\Controllers\Customer\CustomerController::class, 'comment']);
    Route::post('/posts/{post}/likes', [\App\Http\Controllers\Customer\CustomerController::class, 'like']);
